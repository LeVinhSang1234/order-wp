    ...
    <div class="notification-dashboard">
      ...
      <div class="list-status order-status">
        <?php foreach ($status_str as $key => $status) { ?>
          <?php if ($key > 0) { ?>
            <div class="<?php echo (($order->status == 8 && $key === intval($order->status)) ? "status-red" : "") ?> <?php echo ($key === intval($order->status) ? "status-active" : "") ?>"
          ...
          <div class="accordion mt-3" id="accordionPanelsStayOpenExample">
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button text-uppercase p-3 fw-bold" type="button"
                  ...
                  <div class="d-flex">
                    <div class="history-all">
                      <div class="history-content clearfix">
                        <ul>
                          ...
                          <li class="ng-scope d-flex gap-3">
                            <span class="text-transform ng-binding fw-bold">Đã mua
                              hàng:</span>
                    ...
                    <div class="history-all">
                      <div class="history-content clearfix">
                        <ul>
                          <li class="ng-scope d-flex gap-3">
                            <span class="text-transform ng-binding fw-bold">Kho Trung
                              Quốc:</span>
                            <p><?php echo $ngay_nhap_kho_tq ?></p>
                          </li>
                          <li class="ng-scope d-flex gap-3">
                            <span class="text-transform ng-binding fw-bold">Kho Việt
                              Nam:</span>
                            <p><?php echo $ngay_nhap_kho_vn ?></p>
                          </li>
                          <li class="ng-scope d-flex gap-3">
                            <span class="text-transform ng-binding fw-bold">Khách nhận
                              hàng:</span>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <input <?php echo $order->status > 1 ? "disabled" : '' ?>
                        data-type="quantity-cart" data-item="<?php echo $cart->id ?>"
            ...
            <div class="chat-box-message">
              ...
              <?php foreach ($chats as $chat) { ?>
                <div style="height: 200px; overflow: auto"
                  class="<?php echo ($chat->is_system === '1' ? " admin-system" : '') ?>">
                  <?php echo trim($chat->text) ?>
                </div>
              <?php } ?>
            </div>
